...
struct myExampleTask {
  ...
  void init(InitContext const&)
  {
    ...
    const AxisSpec axisCounter{1, 0, 1, "Counts"};
    const AxisSpec axisDeltaPt{100, -1.0, +1.0, "Delta(p_{T})"};
    const AxisSpec axisNumReColl{10,0,10, "Number of Reco PVs"};
    const AxisSpec axisCorrel{50,0,50,"Number of tracks"};
    ...
    histos.add("numberOfRecoCollisions","numberOfRecoCollisions", kTH1I, {axisNumReColl});
    histos.add("multiplicityCorrelation","multiplicityCorrelation", kTH2I, {axisCorrel, axisCorrel});
  }
